...
export default function Page() {
  ...
  const savedSummary = savedTreksForMarket[0] ?? null;
  const savedSummaryMarket = savedSummary?.marketName || (selectedMarket ? marketTitle(selectedMarket).toUpperCase() : "PASARAN");
